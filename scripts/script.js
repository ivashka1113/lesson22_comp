...
document.addEventListener("click", (e) => {
    ...
    if (e.target.closest(".top") && buttonIndex > 4) {
        ...
        buttons[buttonIndex].childNodes[1].textContent = buttons[buttonIndex - 5].textContent;
        ...
        let pastValue = buttons[buttonIndex].childNodes[1].textContent;
        buttons[buttonIndex].childNodes[1].textContent = buttons[buttonIndex + 1].textContent;
